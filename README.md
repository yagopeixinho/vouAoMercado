...
- Em algumas telas é indicado um _input color_, sugerindo a cor de alguma interface. É *fortemente recomendado* que você use cores de tons pastéis e evite cores muito saturadas para que você tenha uma melhor experiência visual.
